/// List item rendering a ticket summary: a status dot + mono ticket
/// number + relative time (top row), title, truncated description,
/// status/priority badges, category, and assignee. The status dot in
/// the header gives the list a scannable rhythm without a side-stripe
/// (banned by DESIGN.md). Tap fires [onTap].
library;
            ...
            child: DecoratedBox(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    // Header: status dot + mono ticket number + time.
                    Row(
                      children: <Widget>[
                        Container(
                          width: 7,
